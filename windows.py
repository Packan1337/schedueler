...
class Window:
    def main_window():
        layout = [
            [sg.Text("PACKAN'S SCHEDUELER", font=("Arial", 45), enable_events=True, key="-PACKAN_GITHUB-")],
            [sg.Text("")],
            [sg.Push(),
            sg.Text("Employee", font=("Arial", 14)),
            sg.Combo(["Alicia", "Aria", "Gul", "Katja", "Lina"], font=("Arial", 14), key="-EMPLOYEE-"),
            sg.Push(),
            sg.FileBrowse("SELECT A FILE", font=("Arial", 14), key="-SELECTOR-"),
            sg.Button("CONVERT TO CALENDAR", font=("Arial", 14), key="-CONVERT-"), 
            sg.Push()]
            ]
        ...
        while True:
            ...
            if event == sg.WIN_CLOSED or event == "Cancel":
                ...
                print("got here")
                Window.verify_window(file_to_verify=values["-SELECTOR-"], employee=values["-EMPLOYEE-"])
    ...
    def success_window():
        layout = [
            [sg.Push(), sg.Text("Successfully added events to calendar!", font=("Arial", 14)), sg.Push()],
    ...
    def verify_window(file_to_verify, employee):
        layout = [
            [sg.Text(f"Do you want to use {os.path.basename(file_to_verify)}?", font=("Arial", 14))],
            [sg.Push(),
